---
description: "Learn how Raydium estimates CLMM APR and how the delta and multiplier methods work."
---
...
For estimation of tokenA ($$\Delta X$$) and tokenB ($$\Delta Y$$), you need to know $$\Delta L$$:
...
After calculating $$\Delta L$$, you can calculate $$\Delta X$$ and $$\Delta Y$$ using:
...
| Variable       | Description                                                         |
| -------------- | ------------------------------------------------------------------- |
| $$u\_{lower}$$ | Lower bound of the user's concentrated liquidity price range        |
| $$u\_{upper}$$ | Upper bound of the user's concentrated liquidity price range        |
| $$h\_{lower}$$ | Lower bound of the historical price range across a time period      |
| $$h\_{upper}$$ | Upper bound of the historical price range across a time period      |
